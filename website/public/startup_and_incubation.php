...
<?php
    $page_title = "Startup and Incubation";
    $page_meta_key = "";
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="section__block pb-3">
                                                                    ...
                                                                    <ul class="found__points">
                                                                        ...
                                                                        <li>Services that are provided by EDQI.</li>
                                                                        <li>Impact it is creating in the corporate world.</li>
                                                                        <li>
                                                                            Real-time pictures and Brief report.
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                            </div>
