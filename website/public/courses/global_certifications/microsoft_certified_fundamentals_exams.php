<?php
    $page_title = "Microsoft Certified Fundamentals Exams | Global certifications";
    $page_meta_key = "";
    $page_meta_description = "";
    $course_name = "Microsoft Certified Fundamentals Exams";
    // config file
                                    ...
                                    <article data-aos="fade-up"
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-md-6">
                                                ...
                                                <p>
                                                    Lorem ipsum, dolor sit amet consectetur adipisicing elit. Sed tempore, adipisci animi quod quam voluptatem. Corrupti quasi nisi explicabo possimus.
                                                </p>
                                            </div>
                                            <div class="col-12 col-md-6">
                                                <figure>
                                ...
                                <div class="col-11">
                                    <article data-aos="fade-up"
                                        ...
                                        <ul class="d-md-flex flex-wrap">
                                            ...
                                            <li class="w-50">JQuery</li>
                                            <li class="w-50">PHP</li>
