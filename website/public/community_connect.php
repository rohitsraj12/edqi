                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="section__block pb-3">
                                                                    ...
                                                                    <ul class="found__points">
                                                                        <li>
                                                                            Details regarding the freelancer’s community.
                                                                        </li>
                                                                        <li>Details about the courses provided by the freelancers.</li>
                                                                        <li>Testimonials of freelancers.</li>
                                                                        <li>Numeric data of freelancers and courses.</li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        </div>
