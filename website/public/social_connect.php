...
<?php
    $page_title = "Social Connect";
    $page_meta_key = "";
    $page_meta_description = "";
    $course_name = "Social Connect";
    // config file
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="section__block pb-3">
                                                                    ...
                                                                    <ul class="found__points">
                                                                        <li>
                                                                            Social services provided till now
                                                                        </li>
                                                                        <li>Social concerns and contributions to fix it.</li>
                                                                        <li>Real-time photographs.</li>
